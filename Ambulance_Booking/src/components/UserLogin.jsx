      ...
      <div className="h-auto lg:w-3/4 w-11/12 lg:rounded-3xl shadow-2xl flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="lg:flex flex-col justify-center items-start bg-gradient-to-br from-sky-200 via-sky-300 to-sky-700 p-10 w-full lg:w-3/5 hidden ">
          <img
            src={illustration}
            alt="Illustration"
            className="w-4/5 h-auto mb-6 mx-auto"
          />
        ...
        <div className="w-full lg:w-2/5 bg-white flex flex-col items-center lg:rounded-r-3xl p-8 gap-6">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-4 w-full">
            ...
            <div className="relative w-full">
              ...
              <button
                ...
                className="absolute inset-y-0 right-4 flex items-center text-gray-600 p-2"
            ...
            <button
              type="submit"
              className="w-full bg-[#007f78] text-white font-bold text-lg py-4 rounded-lg transition duration-300 cursor-pointer hover:bg-[#00a99d] focus:ring-2 focus:ring-[#00dfd0] focus:ring-offset-2"
              aria-label="Login"
            >
              Login
            </button>
          ...
          <p className="text-center mt-4 text-gray-700">
            ...
            <Link
              to="/signup"
              className="text-[#007f78] font-semibold underline hover:text-[#00a99d] focus:outline-none focus:ring-2 focus:ring-[#00dfd0] focus:ring-offset-2"
